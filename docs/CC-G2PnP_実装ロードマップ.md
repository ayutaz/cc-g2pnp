...
FlashAttention Phase 1 (SDPA)        ░░░░░░░░░░░░░░░░░░░░░░   ← 次
```

- **Phase 0-5 全完了**（評価パイプラインまで実装済み、490テスト PASS）
...
- **次のステップ**: Phase 2-opt 中コスト改善 (PnP ラベル LMDB キャッシュ等) / FlashAttention Phase 1 (SDPA 統合, `attn_mask` 方式)
...
| **M5: 評価パイプライン完成** | 5 | 全6メトリクス計算、4ドメインビルトインデータ、batch/streaming推論→評価。490テスト | ✅ 達成 |
